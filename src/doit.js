...
(async () => {
    ...
    await page.goto('https://localhost:7198/', {
        waitUntil: 'networkidle2',
    });
    // sessionStorage 설정
    await page.evaluate(() => {
        sessionStorage.setItem('CheckupId', '103');
        sessionStorage.setItem('CheckupTitle', '정기검사 테ㅡ스트');
        sessionStorage.setItem('CheckupEntry', '{"isBP":"true","isHealth":"true"}');
    });
    await page.goto('https://localhost:7198/CheckupReportV2', {
        waitUntil: 'networkidle2',
    });
